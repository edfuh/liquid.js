Liquid.Block = Liquid.Tag.extend({
  ...
  parse: function (tokens) {
    ...
    var
      ...
      tagParts
    ;
    // To ensure we don't lose the last token passed in...
    tokens.push('');
    while (tokens.length) {
      ...
      // Assign the next token to loop again...
      token = tokens.shift();
    }

    // Effectively this method will throw an exception unless the current block is of type Document
